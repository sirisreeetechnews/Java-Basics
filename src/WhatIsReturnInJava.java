...
/*
* return is a keyword,
* used to terminate/return the execution from method
 */
...
// return not required for void return type
 }
 ...
 * In single method we can have multiple return
   statements depends on the requirement/need
 */
 ...
 public static void main(String[] args) {
   ...
   System.out.println("val = " + val);
    ...
    /*
 * In Below method, boolean is return type
 * It has a unreachable statement of
